    ...
    private static function footballPosts(): array
    {
        return [
            [
                ...
                'title' => 'Arsenal do prednosti golom u nadoknadi prvog dijela',
                'lead' => 'Domaći su odigrali najbolju deonicu sezone i kaznili grešku gostujuće odbrane pred odlazak na odmor.',
                'meta' => 'Prije 12 minuta',
                'read_minutes' => 3,
                'author' => 'Marko Ilić',
                'body' => [
                    'Gosti su prvih dvadeset minuta držali posjed, ali bez ozbiljnog udarca ka golu. Prelom je došao poslije prekida na desnoj strani, kada je odbrana ostavila prostor u centru i dozvolila udarac sa ivice šesnaest metara.',
                    'U nastavku se očekuje izmjena u sredini terena, pošto je kapiten igrao sa žutim kartonom od 30. minuta. Domaći su u posljednjih pet kola primili samo dva gola.',
                ],
                'quote' => ['text' => 'Znali smo da će prostora biti poslije prekida.', 'attribution' => 'TRENER DOMAĆIH, POSLIJE PRVOG DIJELA'],
            ...
            [
                ...
                'lead' => 'Katalonci su morali da sačekaju do posljednjih minuta da bi stigli do sva tri boda na svom terenu.',
                'meta' => 'Prije 1 sat',
                'read_minutes' => 2,
                'author' => 'Ana Petrović',
                'body' => [
                    'Sevilja je dobro zatvarala prostor kroz sredinu terena i držala rezultat izjednačenim sve do 86. minuta, kada je promjenom na krilu domaći tim otvorio prostor za odlučujući udarac.',
                ],
                'quote' => null,
